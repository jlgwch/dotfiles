import { For, Accessor, createBinding, createState } from "ags"
...
export default function Applauncher() {
    ...
    // const app_list = createBinding(apps, "list")
    const app_list = apps.get_list()
    setList(app_list)

    function search(text: string) {
        if (text === "") setList(app_list)
    ...
    return (
        ...
        >
            ...
            >
                ...
                <scrolledwindow name="applauncher" heightRequest={600}>
